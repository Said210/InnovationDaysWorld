...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference("Edition.count") do
      post editions_url, params: { edition: { begin_at: @edition.begin_at, end_at: @edition.end_at } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { begin_at: @edition.begin_at, end_at: @edition.end_at } }
